...
- Run the EAcreator.exe 

- select no of account wanted (Max 5 at a time)

- click run

=====[IMPORTANT INFO]======

- an CMD will open "DONT CLOSE IT" with debug log so you can know whats happening and incase of error it is shown in CMD 
